...
The complete analysis and results, including **graphs**, are detailed in the [**analysis_report.md**]([./analysis_report.md](https://github.com/OskarSeierl/distributed-systems/blob/main/analysis_report.md)).
